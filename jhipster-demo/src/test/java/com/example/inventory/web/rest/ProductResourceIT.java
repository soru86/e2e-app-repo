...
import static com.example.inventory.domain.ProductAsserts.*;
import static com.example.inventory.web.rest.TestUtil.createUpdateProxyForBean;
import static com.example.inventory.web.rest.TestUtil.sameNumber;
...
import com.example.inventory.domain.enumeration.ProductStatus;
...
class ProductResourceIT {
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).sku(UPDATED_SKU).price(UPDATED_PRICE).quantity(UPDATED_QUANTITY).status(UPDATED_STATUS);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).sku(UPDATED_SKU).price(UPDATED_PRICE).quantity(UPDATED_QUANTITY).status(UPDATED_STATUS);
